(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_DashView_orders_pay_page_tsx_1df5dc12._.js", {

"[project]/src/app/DashView/orders/pay/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const OrderPaymentPage = ()=>{
    ...
    const [orderId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(orderIdFromQuery || '');
    const [category] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(categoryFromQuery || '');
    const [supplier] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(supplierIdFromQuery || '');
    const [quantity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(quantityFromQuery ? parseInt(quantityFromQuery, 10) : 20);
    const [goldPricePerGram] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(goldPricePerGramFromQuery ? parseFloat(goldPricePerGramFromQuery) : 0);
    const [selectedKarat] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(selectedKaratFromQuery || '24K');
    const [goldPurity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(goldPurityFromQuery ? parseFloat(goldPurityFromQuery) : 0.999);
    const [weightInGrams] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(weightInGramsFromQuery ? parseFloat(weightInGramsFromQuery) : 0);
    const [makingCharges, setMakingCharges] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(makingChargesFromQuery ? parseFloat(makingChargesFromQuery) : 0);
    const [additionalMaterialsCharges] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(additionalMaterialsChargesFromQuery ? parseFloat(additionalMaterialsChargesFromQuery) : 0);
    const [baseEstimatedPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(baseEstimatedPriceFromQuery ? parseFloat(baseEstimatedPriceFromQuery) : 0);
    const [estimatedPrice, setEstimatedPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(estimatedPriceFromQuery ? parseFloat(estimatedPriceFromQuery) : 0);
    const [totalAmount, setTotalAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(totalAmountFromQuery ? parseFloat(totalAmountFromQuery) : 0);
    // For advance payments
    const [currentPaymentAmount, setCurrentPaymentAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0); // The new payment being made now
    const [existingAdvancePayment, setExistingAdvancePayment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(advancePaymentFromQuery ? parseFloat(advancePaymentFromQuery) : 0); // Previously paid amount
    const [totalAdvancePayment, setTotalAdvancePayment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(advancePaymentFromQuery ? parseFloat(advancePaymentFromQuery) : 0); // Total of existing + current
    ...
    const [imagePreview] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(designImageUrlFromQuery || null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrderPaymentPage.useEffect": ()=>{
            if (supplier) {
                const fetchSupplierName = {
                    "OrderPaymentPage.useEffect.fetchSupplierName": async ()=>{
                        try {
                ...
                }["OrderPaymentPage.useEffect.fetchSupplierName"];
                fetchSupplierName();
            }
        }
    }["OrderPaymentPage.useEffect"], [
    ...
    const [customEstimatePrice, setCustomEstimatePrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(estimatedPriceFromQuery ? parseFloat(estimatedPriceFromQuery) : 0);
    const [useCustomEstimate, setUseCustomEstimate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Default to using custom estimate
    // Fetch existing payments for this order
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrderPaymentPage.useEffect": ()=>{
            if (orderId) {
                const fetchExistingPayments = {
                    "OrderPaymentPage.useEffect.fetchExistingPayments": async ()=>{
                        try {
                            ...
                            if (response.ok) {
                                ...
                                if (result.success && result.summary) {
                                    ...
                                    if (result.data && result.data.length > 0) {
                                        totalPaid = result.data.reduce({
                                            "OrderPaymentPage.useEffect.fetchExistingPayments": (sum, payment)=>sum + parseFloat(payment.amount_paid)
                                        }["OrderPaymentPage.useEffect.fetchExistingPayments"], 0);
                                    }
                ...
                }["OrderPaymentPage.useEffect.fetchExistingPayments"];
                                                        ...
                                                        children: [
                                                            ...
                                                            useCustomEstimate && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    customEstimatePrice > estimatedPrice ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(OrderPaymentPage, "xMWDSUTlaX6Cnr3fqa7RnfgA9zM=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "OrderPaymentPage");
...
//# sourceMappingURL=src_app_DashView_orders_pay_page_tsx_1df5dc12._.js.map