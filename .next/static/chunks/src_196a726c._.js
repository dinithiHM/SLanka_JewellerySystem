            ...
            const fetchData = {
                "ImprovedCategoryChart.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        orderStatsData.forEach({
                            "ImprovedCategoryChart.useEffect.fetchData": (stat)=>{
                        ...
                        suppliersData = suppliersData.map({
                            "ImprovedCategoryChart.useEffect.fetchData": (supplier)=>({
                                    ...supplier,
                                    order_count: supplierOrderCounts.get(supplier.supplier_id.toString()) || 0
                                })
                        }["ImprovedCategoryChart.useEffect.fetchData"]).sort({
                            "ImprovedCategoryChart.useEffect.fetchData": (a, b)=>(b.order_count || 0) - (a.order_count || 0)
                        }["ImprovedCategoryChart.useEffect.fetchData"]);
...
_s(ImprovedCategoryChart, "TVrHVeeit3oFBxhN2Q6qhCCcvOY=");
...
const CreateCustomOrderPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateCustomOrderPage.useEffect": ()=>{
            const fetchData = {
                "CreateCustomOrderPage.useEffect.fetchData": async ()=>{
                    try {
                        // Fetch categories
            ...
            }["CreateCustomOrderPage.useEffect.fetchData"];
            fetchData();
        }
    }["CreateCustomOrderPage.useEffect"], []);
...
_s(CreateCustomOrderPage, "5n6Jk/RR4ADTKgolnjrcKd7mzn8=", false, function() {
    return [
