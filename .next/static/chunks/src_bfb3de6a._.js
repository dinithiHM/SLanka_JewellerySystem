(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_bfb3de6a._.js", {
...
const UserCard = ({ type })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserCard.useEffect": ()=>{
            const fetchCount = {
                "UserCard.useEffect.fetchCount": async ()=>{
                    setLoading(true);
                    setError(null);
                    try {
            ...
            }["UserCard.useEffect.fetchCount"];
            fetchCount();
            // Set up interval to refresh data every 30 seconds
            const intervalId = setInterval(fetchCount, 30000);
            // Clean up interval on component unmount
            return ({
                "UserCard.useEffect": ()=>clearInterval(intervalId)
            })["UserCard.useEffect"];
        }
    }["UserCard.useEffect"], [
        type
...
_s(UserCard, "q83HLL/+SSoesVNCKiQwLhFUn60=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"]
    ];
});
...
//# sourceMappingURL=src_bfb3de6a._.js.map