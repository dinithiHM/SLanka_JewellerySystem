(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_c347ce45._.js", {
...
"[project]/src/utils/translator.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const DynamicText = ({ text, className })=>{
    ...
    const [translatedText, setTranslatedText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(text);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DynamicText.useEffect": ()=>{
            let isMounted = true;
            const translate = {
                "DynamicText.useEffect.translate": async ()=>{
            ...
            }["DynamicText.useEffect.translate"];
            translate();
            return ({
                "DynamicText.useEffect": ()=>{
                    isMounted = false;
...
_s2(DynamicText, "r/mjfu7iHUwoTOCemItOKwwovXc=", false, function() {
    return [
        useLanguage
    ];
});
...
__turbopack_context__.k.register(_c1, "DynamicText");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_c347ce45._.js.map