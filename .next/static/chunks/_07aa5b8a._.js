(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_07aa5b8a._.js", {
...
"[project]/src/utils/invoiceGenerator.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const generateInvoicePDF = async (sale, branchDetails)=>{
    try {
        ...
        doc.text('S.LANKA GOLD JEWELLERY', 105, 25, {
            align: 'center'
        });
        // Add branch details
        doc.setFontSize(10);
        ...
        doc.text(location, 105, 35, {
            align: 'center'
        });
        doc.text(contactNumber, 105, 40, {
            align: 'center'
        });
        ...
        sale.items.forEach((item)=>{
            ...
            doc.text((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formatters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(item.subtotal), 170, yPos, {
                align: 'right'
            });
            yPos += 8;
        });
        ...
        doc.text((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formatters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(sale.total_amount), 170, yPos, {
            align: 'right'
        });
        yPos += 8;
        ...
        if (hasDiscounts) {
            ...
            doc.text(`${discountPercentage}.00%`, 170, yPos, {
                align: 'right'
            });
            yPos += 8;
        } else {
        ...
        doc.setFontSize(9);
        doc.setFont('helvetica', 'normal');
        doc.text('Make all checks payable to S.LANKA GOLD JEWELLERY', 105, yPos, {
            align: 'center'
        });
        yPos += 5;
        doc.text('If you have any questions concerning this invoice, use the following contact information:', 105, yPos, {
            align: 'center'
        });
        yPos += 5;
        doc.text(`Asam Saleem, ${contactNumber}`, 105, yPos, {
            align: 'center'
        });
        yPos += 10;
        doc.setFont('helvetica', 'bold');
        doc.text('THANK YOU FOR YOUR BUSINESS!', 105, yPos, {
            align: 'center'
        });
...
"[project]/src/app/DashView/sales/details/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formatters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/formatters.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$invoiceGenerator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/invoiceGenerator.js [app-client] (ecmascript)");
;
...
const SaleDetailsPage = ({ params })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SaleDetailsPage.useEffect": ()=>{
            const fetchSaleDetails = {
                "SaleDetailsPage.useEffect.fetchSaleDetails": async ()=>{
                    try {
                        setLoading(true);
            ...
            }["SaleDetailsPage.useEffect.fetchSaleDetails"];
            if (saleId) {
                fetchSaleDetails();
            }
        }
    ...
    const handleDownloadInvoice = async ()=>{
        ...
        try {
            ...
            try {
                const pdfBlob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$invoiceGenerator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateInvoicePDF"])(data.sale, data.branchDetails);
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/src/app/DashView/sales/details/[id]/page.tsx",
                lineNumber: 179,
                columnNumber: 9
            }, this)
        }, void 0, false, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "font-medium",
                                                children: sale.invoice_number || /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    className: "bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-2 px-4 rounded-full",
                                                    onClick: handleDownloadInvoice,
                                                    disabled: generatingInvoice,
                                                    children: generatingInvoice ? 'Generating...' : 'Generate Invoice'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/DashView/sales/details/[id]/page.tsx",
                                                    lineNumber: 258,
                                                    columnNumber: 19
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            ...
                                            children: [
                                                sale.items.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                className: "px-6 py-4 whitespace-nowrap",
                                                                children: item.original_price ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formatters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(item.original_price) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formatters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(item.unit_price)
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/DashView/sales/details/[id]/page.tsx",
                                                                lineNumber: 318,
                                                                columnNumber: 21
...
_s(SaleDetailsPage, "v/1hmkPBKZR7QXNcfsc8c0328dQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = SaleDetailsPage;
const __TURBOPACK__default__export__ = SaleDetailsPage;
var _c;
__turbopack_context__.k.register(_c, "SaleDetailsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_07aa5b8a._.js.map