(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_01cee758._.js", {
 ...
 */ const TranslationProvider = ({ children })=>{
    ...
    const { language, isAutoTranslateEnabled, translateDynamic } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TranslationProvider.useEffect": ()=>{
            ...
            const translateTextNodes = {
                "TranslationProvider.useEffect.translateTextNodes": async ()=>{
                    try {
                        // Add data-no-auto-translate attribute to menu items and language selector
                        document.querySelectorAll('.menu-item, .language-selector, [data-no-translate]').forEach({
                            "TranslationProvider.useEffect.translateTextNodes": (el)=>{
                                el.setAttribute('data-no-auto-translate', 'true');
                            }
                        }["TranslationProvider.useEffect.translateTextNodes"]);
                        // Get all text nodes that are not inside script or style tags
                        const walker = document.createTreeWalker(document.body, NodeFilter.SHOW_TEXT, {
                            acceptNode: {
                                "TranslationProvider.useEffect.translateTextNodes.walker": (node)=>{
                            ...
                            }["TranslationProvider.useEffect.translateTextNodes.walker"]
                        });
            ...
            if (isAutoTranslateEnabled && language !== 'en') {
                ...
                return ({
                    "TranslationProvider.useEffect": ()=>clearTimeout(timeoutId)
                })["TranslationProvider.useEffect"];
            }
        }
    }["TranslationProvider.useEffect"], [
...
_s(TranslationProvider, "qOqU4kV1dVnuslmfyil4Evwdo6A=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"]
    ];
});
...
//# sourceMappingURL=src_01cee758._.js.map