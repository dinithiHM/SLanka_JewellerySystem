...
const SalesAssociateListPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Fetch sales associates from the backend API
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:3002/sales-associates").then((response)=>{
            setSalesAssociates(response.data);
        }).catch((error)=>{
            console.error("There was an error fetching the sales associates:", error);
        });
    }, []);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__064cddc7._.js.map