...
const CreateCustomOrderPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // Temporarily disable file uploads to test the rest of the form
            console.log('File uploads temporarily disabled for testing');
            // Add a dummy file field to satisfy the server's expectations
            formData.append('images', 'no-file');
            // Send request
...
//# sourceMappingURL=src_31f3bcff._.js.map