...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-rsc] (ecmascript)"); // Import axios
;
;
;
;
const Login = ()=>{
    // State variables to hold the username, password, and error messages
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            // Make POST request to the backend (Node.js server running on port 3002)
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post("http://localhost:3002/login", data);
            // Handle success - assuming the backend responds with a success message or token
            if (response.status === 200) {
                // Do something with the response (e.g., store token, redirect, etc.)
                console.log("Login successful", response.data);
                // Redirect to a different page if needed (e.g., home page)
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8a3af132._.js.map