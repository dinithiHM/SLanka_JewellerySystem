...
const TeacherForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.r("[project]/src/components/forms/TeacherForm.tsx [app-ssr] (ecmascript, next/dynamic entry, async loader)")(__turbopack_context__.i), {
    loadableGenerated: {
        modules: [
...
"[project]/src/app/DashView/list/Supplier/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const columns = [
    ...
    {
        header: "Manufacturing Items",
        accessor: "manufacturing_items",
        className: "hidden md:table-cell"
    },
    {
        header: "Category",
...
const SupplierListPage = ()=>{
    ...
    const handleDelete = async (id)=>{
        try {
            // Check if id is valid and convert to number if needed
            ...
            console.log(`Attempting to delete Supplier with ID: ${numericId}`);
            // Make the delete request
            const response = await fetch(`http://localhost:3002/suppliers/delete/${numericId}`, {
                method: 'DELETE'
            });
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                    ...
                    fileName: "[project]/src/app/DashView/list/Supplier/page.tsx",
                    lineNumber: 202,
                    columnNumber: 9
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                    className: "hidden md:table-cell",
                    children: item.supplier_id || 'N/A'
                }, void 0, false, {
                    fileName: "[project]/src/app/DashView/list/Supplier/page.tsx",
                    lineNumber: 203,
                    columnNumber: 9
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                    className: "hidden md:table-cell",
                    children: item.manufacturing_items || 'N/A'
                }, void 0, false, {
                    fileName: "[project]/src/app/DashView/list/Supplier/page.tsx",
                    lineNumber: 206,
                    columnNumber: 9
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            userRole.toLowerCase() === "admin" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                                children: [
                                    console.log("Supplier ID for delete:", item.id),
                                    " ",
                                    console.log("Supplier ID for delete (raw):", item.id, typeof item.id),
                                    console.log("Supplier full item:", JSON.stringify(item)),
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$DeleteConfirmationModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                        itemName: item.name || 'this supplier',
                                        onDelete: ()=>{
                                            // Get the ID and ensure it's a number
                                            const idToDelete = parseInt(String(item.id), 10);
                                            console.log("Delete button clicked for ID:", idToDelete, typeof idToDelete);
                                            return handleDelete(idToDelete);
                                        }
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/DashView/list/Supplier/page.tsx",
                                        lineNumber: 220,
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            lineNumber: 238,
            columnNumber: 12
        }, this); // Display loading text while data is being fetched
    }
    if (error) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            children: [
    ...
    // Create a debug component to show supplier data
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                            className: "bg-white p-2 rounded text-xs overflow-auto max-h-40",
                            children: JSON.stringify(suppliers.slice(0, 3), null, 2)
                        }, void 0, false, {
                            fileName: "[project]/src/app/DashView/list/Supplier/page.tsx",
                            lineNumber: 253,
                            columnNumber: 11
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        onClick: ()=>{
                            // Test delete with the first supplier's ID
                            if (suppliers.length > 0) {
                                const firstId = suppliers[0].id;
                                console.log('Test delete with ID:', firstId, typeof firstId);
                                // Try to convert to number explicitly
                                const numericId = parseInt(String(firstId), 10);
                                console.log('Converted ID:', numericId, typeof numericId);
                                if (!isNaN(numericId)) {
                                    handleDelete(numericId);
                                } else {
                                    alert('Could not convert ID to number');
                                }
                            } else {
                                alert('No suppliers to delete');
                            }
                        },
                        children: "Test Delete First Supplier"
                    }, void 0, false, {
                        fileName: "[project]/src/app/DashView/list/Supplier/page.tsx",
                        lineNumber: 258,
                        columnNumber: 11
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ("TURBOPACK compile-time value", "development") !== 'production' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DebugSupplierData, {}, void 0, false, {
                fileName: "[project]/src/app/DashView/list/Supplier/page.tsx",
                lineNumber: 288,
                columnNumber: 49
            }, this),
...
const __TURBOPACK__default__export__ = SupplierListPage;
}}),
...
//# sourceMappingURL=_8f0ca9d7._.js.map